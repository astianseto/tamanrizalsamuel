...
<main class="max-w-3xl mx-auto py-12 px-6">
    ...
    <form action="{{ route('aduan.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input type="text" id="alamat" name="alamat" value="{{ old('alamat') }}" placeholder="Masukkan alamat Anda"
                required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            @error('alamat')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <!-- Deskripsi -->
        <div>
            <label for="aduan" class="block font-semibold mb-1">Deskripsi Laporan <span
        ...
        <div>
            ...
            <input type="text" id="telfon" name="telfon" value="{{ old('telfon') }}"
